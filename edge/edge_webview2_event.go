...
// Event_RasterizationScaleChanged 光栅化缩放比例改变事件. 返回回调函数 ID.
...
// Event_WindowCloseRequested 窗口关闭请求事件. 返回回调函数 ID.
...
// Event_SourceChanged 源改变事件. 返回回调函数 ID.
...
// Event_NewWindowRequested 新窗口请求事件. 返回回调函数 ID.
...
// Event_PermissionRequested 权限请求事件. 返回回调函数 ID.
...
// Event_WebMessageReceived 网页消息事件. 返回回调函数 ID.
...
// Event_WebResourceRequested 网页资源请求事件. 返回回调函数 ID.
//
// cb: 回调函数.
//
// allowAddingMultiple: 是否允许添加多个回调函数, 不填默认为 true.
...
// Event_NavigationCompleted 导航完成事件. 返回回调函数 ID.
...
// Event_Frame_NavigationCompleted 框架导航完成事件. 返回回调函数 ID.
...
// Event_Frame_NavigationStarting 是 ICoreWebView2 的框架导航开始事件. 返回回调函数 ID.
...
// Event_NavigationStarting 导航开始事件. 返回回调函数 ID.
...
// Event_AcceleratorKeyPressed 快捷键事件. 返回回调函数 ID.
...
// Event_ContentLoading 网页内容正在加载事件. 返回回调函数 ID.
...
// Event_ContainsFullScreenElementChanged 全屏元素状态改变事件. 返回回调函数 ID.
...
// Event_ProcessFailed 进程失败事件. 返回回调函数 ID.
...
// Event_HistoryChanged 历史记录改变事件. 返回回调函数 ID.
...
// Event_ScriptDialogOpening 脚本对话框打开事件. 返回回调函数 ID.
...
// Event_WebResourceResponseReceived 是 Web 资源响应接收事件. 返回回调函数 ID.
...
// Event_DOMContentLoaded 是 DOM 内容加载完成事件. 返回回调函数 ID.
...
// Event_FrameCreated 框架创建完成事件. 返回回调函数 ID.
//   - 当创建新的 iframe 时触发。
...
// Event_DownloadStarting 下载开始事件. 返回回调函数 ID.
...
// Event_ClientCertificateRequested 客户端证书请求事件. 返回回调函数 ID.
...
// Event_IsMutedChanged 静音状态改变事件. 返回回调函数 ID.
...
// Event_DocumentPlayingAudioChanged 文档播放音频状态改变事件. 返回回调函数 ID.
//
// cb: 回调函数.
//
// allowAddingMultiple: 是否允许添加多个回调函数, 不填默认为 true.
...
// Event_ContextMenuRequested 上下文菜单请求事件. 返回回调函数 ID.
...
// Event_BrowserProcessExited 浏览器进程退出事件. 返回回调函数 ID.
...
// Event_ProcessInfosChanged 进程信息变更事件. 返回回调函数 ID.
...
// Event_FaviconChanged 网站图标改变事件. 返回回调函数 ID.
...
// Event_ZoomFactorChanged 缩放因子改变事件. 返回回调函数 ID.
...
// Event_MoveFocusRequested 移动焦点请求事件. 返回回调函数 ID.
...
// Event_GotFocus 获得焦点事件. 返回回调函数 ID.
//   - 当 WebView 获得焦点时触发。
//
// cb: 回调函数.
//
...
// Event_LostFocus 失去焦点事件. 返回回调函数 ID.
//   - 当 WebView 失去焦点时触发。
//
// cb: 回调函数.
//
...
// Event_NewBrowserVersionAvailable 新浏览器版本可用事件. 返回回调函数 ID.
...
// Event_IsDefaultDownloadDialogOpenChanged 默认下载对话框打开状态变化事件. 返回回调函数 ID.
...
// Event_BasicAuthenticationRequested 基本身份验证请求事件. 返回回调函数 ID.
...
// Event_StatusBarTextChanged 状态栏文本改变事件. 返回回调函数 ID.
...
// Event_ServerCertificateErrorDetected 检测到服务器证书错误事件. 返回回调函数 ID.
...
// Event_LaunchingExternalUriScheme 启动外部 URI 方案事件. 返回回调函数 ID.
...
// Event_NotificationReceived 通知接收事件. 返回回调函数 ID.
...
// Event_SaveAsUIShowing 另存为界面显示事件. 返回回调函数 ID.
...
// Event_SaveFileSecurityCheckStarting 保存文件安全检查开始事件. 返回回调函数 ID.
...
// Event_ScreenCaptureStarting 屏幕截图开始事件. 返回回调函数 ID.
//
// cb: 回调函数.
//
// allowAddingMultiple: 是否允许添加多个回调函数, 不填默认为 true.
