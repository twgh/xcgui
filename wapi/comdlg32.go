...
type OpenFileNameW struct {
	...
	// 从路径开头到lpstrFile指向的字符串中的文件名的从零开始的偏移量（以字符为单位）。对于 Unicode 版本，这是字符数。例如:
	...
	// 由hInstance成员标识的模块中对话模板资源的名称。对于编号的对话框资源，这可以是 MAKEINTRESOURCE 宏返回的值。除非在Flags成员中设置了 OFN_ENABLETEMPLATE 标志，否则该成员将被忽略.
