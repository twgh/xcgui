...
func (a *App) SetProperty(hXCGUI int, name string, value string) bool {
	return xc.XC_SetProperty(hXCGUI, name, value)
}
...
func (a *App) GetProperty(hXCGUI int, name string) string {
	return xc.XC_GetProperty(hXCGUI, name)
}
...
func (a *App) RegisterWindowClassName(className string) bool {
	return xc.XC_RegisterWindowClassName(className)
}
...
func (a *App) GetObjectByIDName(hWindow int, name string) int {
	return xc.XC_GetObjectByIDName(hWindow, name)
}
...
func (a *App) GetObjectByUIDName(name string) int {
	return xc.XC_GetObjectByUIDName(name)
}
...
func (a *App) GetObjectByName(name string) int {
	return xc.XC_GetObjectByName(name)
}
...
func (a *App) GetTextSize(str string, length int32, hFontX int, pOutSize *xc.SIZE) *App {
	xc.XC_GetTextSize(str, length, hFontX, pOutSize)
	return a
}
...
func (a *App) GetTextShowSize(str string, length int32, hFontX int, pOutSize *xc.SIZE) *App {
	xc.XC_GetTextShowSize(str, length, hFontX, pOutSize)
	return a
}
...
func (a *App) GetTextShowSizeEx(str string, length int32, hFontX int, nTextAlign xcc.TextFormatFlag_, pOutSize *xc.SIZE) *App {
	xc.XC_GetTextShowSizeEx(str, length, hFontX, nTextAlign, pOutSize)
	return a
}
...
func (a *App) GetTextShowRect(str string, length int32, hFontX int, nTextAlign xcc.TextFormatFlag_, width int32, pOutSize *xc.SIZE) *App {
	xc.XC_GetTextShowRect(str, length, hFontX, nTextAlign, width, pOutSize)
	return a
}
...
func (a *App) InitFont(pFont *xc.LOGFONTW, name string, size int32, bBold bool, bItalic bool, bUnderline bool, bStrikeOut bool) *App {
	xc.XC_InitFont(pFont, name, size, bBold, bItalic, bUnderline, bStrikeOut)
	return a
}
...
func (a *App) Sys_ShellExecute(hwnd uintptr, operation string, filePath string, parameters string, directory string, nShowCmd xcc.SW_) uintptr {
	return xc.XC_Sys_ShellExecute(hwnd, operation, filePath, parameters, directory, nShowCmd)
}
...
func (a *App) LoadLibrary(fileName string) uintptr {
	return xc.XC_LoadLibrary(fileName)
}
...
func (a *App) GetProcAddress(hModule uintptr, procName string) uintptr {
	return xc.XC_GetProcAddress(hModule, procName)
}
...
func (a *App) LoadDll(dllFileName string) uintptr {
	return xc.XC_LoadDll(dllFileName)
}
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 可填0.
func (a *App) LoadLayoutEx(fileName, prefixName string, hParent int, hParentWnd, hAttachWnd uintptr) int {
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 可填0.
func (a *App) LoadLayoutZipEx(zipFileName string, fileName string, password, prefixName string, hParent int, hParentWnd, hAttachWnd uintptr) int {
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 可填0.
func (a *App) LoadLayoutZipMemEx(data []byte, fileName string, password, prefixName string, hParent int, hParentWnd, hAttachWnd uintptr) int {
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 可填0.
func (a *App) LoadLayoutFromStringWEx(xmlStr, prefixName string, hParent int, hParentWnd, hAttachWnd uintptr) int {
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 可填0.
func (a *App) LoadLayoutFromString(xmlStr string, hParent int, hAttachWnd uintptr) int {
	return xc.XC_LoadLayoutFromString(xmlStr, hParent, hAttachWnd)
}
*/
...
func (a *App) LoadStyle(fileName string) bool {
	return xc.XC_LoadStyle(fileName)
}
...
func (a *App) LoadResource(fileName string) bool {
	return xc.XC_LoadResource(fileName)
}
...
func (a *App) LoadResourceFromStringW(xmlStr string, fileName string) bool {
	return xc.XC_LoadResourceFromStringW(xmlStr, fileName)
}
...
func (a *App) WtoUtf8Ex(value string, length int32) uintptr {
	return xc.XC_wtoutf8Ex(value, length)
}
...
func (a *App) UnicodeToAnsi(in string, inLen int32, pOut uintptr, outLen int32) int32 {
	return xc.XC_UnicodeToAnsi(in, inLen, pOut, outLen)
}
...
//
// fileName: 资源文件名.
func (a *App) LoadResourceFromString(xmlStr string, fileName string) bool {
	return xc.XC_LoadResourceFromString(xmlStr, fileName)
}
...
//
// str: 字符串.
func (a *App) LoadStyleFromString(fileName string, str string) bool {
	return xc.XC_LoadStyleFromString(fileName, str)
} */
...
func (a *App) LoadStyleFromStringW(fileName string, str string) bool {
	return xc.XC_LoadStyleFromStringW(fileName, str)
}
...
func (a *App) NotifyMsg_Popup(position xcc.Position_Flag_, title, text string, hIcon int, skin xcc.NotifyMsg_Skin_) int {
	return xc.XNotifyMsg_Popup(position, title, text, hIcon, skin)
}
...
func (a *App) NotifyMsg_PopupEx(position xcc.Position_Flag_, title, text string, hIcon int, skin xcc.NotifyMsg_Skin_, bBtnClose, bAutoClose bool, nWidth, nHeight int32) int {
	return xc.XNotifyMsg_PopupEx(position, title, text, hIcon, skin, bBtnClose, bAutoClose, nWidth, nHeight)
}
...
func (a *App) NotifyMsg_SetDuration(hWindow int, duration uint32) *App {
	xc.XNotifyMsg_SetDuration(hWindow, duration)
	return a
}
...
func (a *App) NotifyMsg_SetParentMargin(hWindow int, left, top, right, bottom int32) *App {
	xc.XNotifyMsg_SetParentMargin(hWindow, left, top, right, bottom)
	return a
}
...
func (a *App) NotifyMsg_SetCaptionHeight(hWindow int, nHeight int32) *App {
	xc.XNotifyMsg_SetCaptionHeight(hWindow, nHeight)
	return a
}
...
func (a *App) NotifyMsg_SetWidth(hWindow int, nWidth int32) *App {
	xc.XNotifyMsg_SetWidth(hWindow, nWidth)
	return a
}
...
func (a *App) NotifyMsg_SetSpace(hWindow int, nSpace int32) *App {
	xc.XNotifyMsg_SetSpace(hWindow, nSpace)
	return a
}
...
func (a *App) NotifyMsg_SetBorderSize(hWindow int, left, top, right, bottom int32) *App {
	xc.XNotifyMsg_SetBorderSize(hWindow, left, top, right, bottom)
	return a
}
