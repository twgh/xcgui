...
func NewElement(x int, y int, cx int, cy int, hParent int) *Element {
	p := &Element{
		HEle: xc.XEle_Create(x, y, cx, cy, hParent),
	}
	return p
}

// 给本类的HEle赋值
func (e *Element) SetHEle(hEle int) {
	e.HEle = hEle
}
...
func (e *Element) RegEventC(nEvent int, pFun interface{}) bool {
	return xc.XEle_RegEventC(e.HEle, nEvent, pFun)
}
...
func (e *Element) RegEventC1(nEvent int, pFun interface{}) bool {
	return xc.XEle_RegEventC1(e.HEle, nEvent, pFun)
}
...
func (e *Element) RemoveEventC(nEvent int, pFun interface{}) bool {
	return xc.XEle_RemoveEventC(e.HEle, nEvent, pFun)
}
...
func (e *Element) SendEvent(nEvent int, wParam int, lParam int) int {
	return xc.XEle_SendEvent(e.HEle, nEvent, wParam, lParam)
}
...
func (e *Element) InsertChild(hChild int, index int) bool {
	return xc.XEle_InsertChild(e.HEle, hChild, index)
}

// 元素_显示
// bShow: TRUE显示元素
func (e *Element) Show(bShow bool) int {
	return xc.XEle_Show(e.HEle, bShow)
}
...
func (e *Element) SetRect(pRect *xc.RECT, bRedraw bool, nFlags int, nAdjustNo int) int {
	return xc.XEle_SetRect(e.HEle, pRect, bRedraw, nFlags, nAdjustNo)
}
...
func (e *Element) SetRectEx(x int, y int, cx int, cy int, bRedraw bool, nFlags int, nAdjustNo int) int {
	return xc.XEle_SetRectEx(e.HEle, x, y, cx, cy, bRedraw, nFlags, nAdjustNo)
}
...
func (e *Element) SetRectLogic(pRect *xc.RECT, bRedraw bool, nFlags int, nAdjustNo int) int {
	return xc.XEle_SetRectLogic(e.HEle, pRect, bRedraw, nFlags, nAdjustNo)
}
...
func (e *Element) Move(x int, y int, bRedraw bool, nFlags int, nAdjustNo int) int {
	return xc.XEle_Move(e.HEle, x, y, bRedraw, nFlags, nAdjustNo)
}
...
func (e *Element) SetZOrderEx(hDestEle int, nType int) bool {
	return xc.XEle_SetZOrderEx(e.HEle, hDestEle, nType)
}

// 元素_取Z序, 获取元素Z序索引, 位置索引
func (e *Element) GetZOrder() int {
	return xc.XEle_GetZOrder(e.HEle)
}

// 元素_启用置顶, 设置元素置顶.
// bTopmost: 是否置顶显示
func (e *Element) EnableTopmost(bTopmost bool) bool {
	return xc.XEle_EnableTopmost(e.HEle, bTopmost)
}

// 元素_重绘
// bImmediate: 是否立即重绘
func (e *Element) Redraw(bImmediate bool) int {
	return xc.XEle_Redraw(e.HEle, bImmediate)
}
...
func (e *Element) SetBorderSize(left int, top int, right int, bottom int) int {
	return xc.XEle_SetBorderSize(e.HEle, left, top, right, bottom)
}

// 元素_取边框大小
// pBorder: 大小.
func (e *Element) GetBorderSize(pBorder *xc.RECT) int {
	return xc.XEle_GetBorderSize(e.HEle, pBorder)
}
...
func (e *Element) SetPadding(left int, top int, right int, bottom int) int {
	return xc.XEle_SetPadding(e.HEle, left, top, right, bottom)
}

// 元素_取内填充大小
// pPadding: 大小.
func (e *Element) GetPadding(pPadding *xc.RECT) int {
	return xc.XEle_GetPadding(e.HEle, pPadding)
}

// 元素_置拖动边框
// nFlags: 边框位置组合, Element_Position_
func (e *Element) SetDragBorder(nFlags int) int {
	return xc.XEle_SetDragBorder(e.HEle, nFlags)
}
...
func (e *Element) SetDragBorderBindEle(nFlags int, hBindEle int, nSpace int) int {
	return xc.XEle_SetDragBorderBindEle(e.HEle, nFlags, hBindEle, nSpace)
}
...
func (e *Element) SetMinSize(nWidth int, nHeight int) int {
	return xc.XEle_SetMinSize(e.HEle, nWidth, nHeight)
}
...
func (e *Element) SetMaxSize(nWidth int, nHeight int) int {
	return xc.XEle_SetMaxSize(e.HEle, nWidth, nHeight)
}
...
func (e *Element) SetLockScroll(bHorizon bool, bVertical bool) int {
	return xc.XEle_SetLockScroll(e.HEle, bHorizon, bVertical)
}
...
func (e *Element) SetTextColor(color int, alpha uint8) int {
	return xc.XEle_SetTextColor(e.HEle, color, alpha)
}

// 元素_取文本颜色
func (e *Element) GetTextColor() int {
	return xc.XEle_GetTextColor(e.HEle)
}

// 元素_取文本颜色扩展, 获取文本颜色, 优先从资源中获取
func (e *Element) GetTextColorEx() int {
	return xc.XEle_GetTextColorEx(e.HEle)
}
...
func (e *Element) SetFocusBorderColor(color int, alpha uint8) int {
	return xc.XEle_SetFocusBorderColor(e.HEle, color, alpha)
}

// 元素_取焦点边框颜色
func (e *Element) GetFocusBorderColor() int {
	return xc.XEle_GetFocusBorderColor(e.HEle)
}

// 元素_置字体
// hFontx: 炫彩字体.
func (e *Element) SetFont(hFontx int) int {
	return xc.XEle_SetFont(e.HEle, hFontx)
}

// 元素_取字体
func (e *Element) GetFont() int {
	return xc.XEle_GetFont(e.HEle)
}

// 元素_取字体扩展, 获取元素字体, 优先从资源中获取
func (e *Element) GetFontEx() int {
	return xc.XEle_GetFontEx(e.HEle)
}

// 元素_置透明度
// alpha: 透明度.
func (e *Element) SetAlpha(alpha uint8) int {
	return xc.XEle_SetAlpha(e.HEle, alpha)
}

// 元素_销毁
func (e *Element) Destroy() int {
	return xc.XEle_Destroy(e.HEle)
}
...
func (e *Element) AddBkBorder(color int, alpha uint8, width int) int {
	return xc.XEle_AddBkBorder(e.HEle, color, alpha, width)
}
...
func (e *Element) DrawFocus(hDraw int, pRect *xc.RECT) bool {
	return xc.XEle_DrawFocus(e.HEle, hDraw, pRect)
}

// 元素_绘制, 在自绘事件函数中, 用户手动调用绘制元素, 以便控制绘制顺序
// hDraw: 图形绘制句柄.
func (e *Element) DrawEle(hDraw int) int {
	return xc.XEle_DrawEle(e.HEle, hDraw)
}

// 元素_置用户数据
// nData: 用户数据.
func (e *Element) SetUserData(nData int) int {
	return xc.XEle_SetUserData(e.HEle, nData)
}

// 元素_取用户数据
func (e *Element) GetUserData() int {
	return xc.XEle_GetUserData(e.HEle)
}
...
func (e *Element) GetContentSize(bHorizon bool, pSize *xc.SIZE, cx int, cy int) int {
	return xc.XEle_GetContentSize(e.HEle, bHorizon, pSize, cx, cy)
}

// 元素_置鼠标捕获
// b: TRUE设置
func (e *Element) SetCapture(b bool) int {
	return xc.XEle_SetCapture(e.HEle, b)
}
...
func (e *Element) EnableTransparentChannel(bEnable bool) int {
	return xc.XEle_EnableTransparentChannel(e.HEle, bEnable)
}
...
func (e *Element) SetXCTimer(nIDEvent int, uElapse int) bool {
	return xc.XEle_SetXCTimer(e.HEle, nIDEvent, uElapse)
}

// 元素_关闭炫彩定时器, 关闭元素定时器
// nIDEvent: 事件ID.
func (e *Element) KillXCTimer(nIDEvent int) bool {
	return xc.XEle_KillXCTimer(e.HEle, nIDEvent)
}

// 元素_置工具提示, 设置工具提示内容
// pText: 工具提示内容.
func (e *Element) SetToolTip(pText string) int {
	return xc.XEle_SetToolTip(e.HEle, pText)
}
...
func (e *Element) SetToolTipEx(pText string, nTextAlign int) int {
	return xc.XEle_SetToolTipEx(e.HEle, pText, nTextAlign)
}

// 元素_取工具提示, 获取工具提示内容
func (e *Element) GetToolTip() int {
	return xc.XEle_GetToolTip(e.HEle)
}
...
func (e *Element) PopupToolTip(x int, y int) int {
	return xc.XEle_PopupToolTip(e.HEle, x, y)
}

// 元素_调整布局
// nAdjustNo:
func (e *Element) AdjustLayout(nAdjustNo int) int {
	return xc.XEle_AdjustLayout(e.HEle, nAdjustNo)
}
...
func (e *Element) AdjustLayoutEx(nFlags int, nAdjustNo int) int {
	return xc.XEle_AdjustLayoutEx(e.HEle, nFlags, nAdjustNo)
}
...
func (b *Element) Event_MENU_SELECT(pFun func(nID int, pbHandled *bool) int) bool {
	return xc.XEle_RegEventC(b.HEle, xcc.XE_MENU_SELECT, pFun)
}

// 事件_菜单弹出
func (b *Element) Event_MENU_POPUP(pFun func(HMENUX int, pbHandled *bool) int) bool {
	return xc.XEle_RegEventC(b.HEle, xcc.XE_MENU_POPUP, pFun)
}

// 事件_菜单退出
func (b *Element) Event_MENU_EXIT(pFun func(pbHandled *bool) int) bool {
	return xc.XEle_RegEventC(b.HEle, xcc.XE_MENU_EXIT, pFun)
}
