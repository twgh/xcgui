...
func (e *Element) GetType() int {
	return xc.XEle_GetType(e.Handle)
}

// 元素_取HWND
func (e *Element) GetHWND() int {
	return xc.XEle_GetHWND(e.Handle)
}

// 元素_取HWINDOW
func (e *Element) GetHWINDOW() int {
	return xc.XEle_GetHWINDOW(e.Handle)
}
...
func (e *Element) Show(bShow bool) int {
	return xc.XEle_Show(e.Handle, bShow)
}
...
func (e *Element) SetID(nID int) int {
	return xc.XEle_SetID(e.Handle, nID)
}

// 元素_取ID
func (e *Element) GetID() int {
	return xc.XEle_GetID(e.Handle)
}

// 元素_置UID, 置元素UID, 全局唯一标识符
// nUID: UID值.
func (e *Element) SetUID(nUID int) int {
	return xc.XEle_SetUID(e.Handle, nUID)
}

// 元素_取UID
func (e *Element) GetUID() int {
	return xc.XEle_GetUID(e.Handle)
}

// 元素_置名称
// pName: name值
func (e *Element) SetName(pName string) int {
	return xc.XEle_SetName(e.Handle, pName)
}

// 元素_取名称
func (e *Element) GetName() int {
	return xc.XEle_GetName(e.Handle)
}

// 元素_判断显示
func (e *Element) IsShow() bool {
	return xc.XEle_IsShow(e.Handle)
}
...
func (e *Element) GetParentEle() int {
	return xc.XEle_GetParentEle(e.Handle)
}

// 元素_取父对象, 获取父对象, 父可能是元素或窗口, 通过此函数可以检查是否有父
func (e *Element) GetParent() int {
	return xc.XEle_GetParent(e.Handle)
}
...
func (e *Element) SetTextColor(color int, alpha uint8) int {
	return xc.XEle_SetTextColor(e.Handle, color, alpha)
}
...
func (e *Element) SetFocusBorderColor(color int, alpha uint8) int {
	return xc.XEle_SetFocusBorderColor(e.Handle, color, alpha)
}
...
func (e *Element) AddBkBorder(color int, alpha uint8, width int) int {
	return xc.XEle_AddBkBorder(e.Handle, color, alpha, width)
}
...
func (e *Element) AddBkFill(color int, alpha uint8) int {
	return xc.XEle_AddBkFill(e.Handle, color, alpha)
}

// 元素_添加背景图片, 添加背景内容图片
// hImage: 图片句柄.
func (e *Element) AddBkImage(hImage int) int {
	return xc.XEle_AddBkImage(e.Handle, hImage)
}
...
func (e *Element) GetContentSize(bHorizon bool, pSize *xc.SIZE, cx int, cy int) int {
	return xc.XEle_GetContentSize(e.Handle, bHorizon, pSize, cx, cy)
}
