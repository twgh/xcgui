...
//
// hModule: 模块句柄, 不填默认为0.
func NewLayoutEleByLayoutZipResEx(id int32, fileName, password, prefixName string, hParent int, hParentWnd, hAttachWnd uintptr, hModule ...uintptr) *LayoutEle {
	return NewLayoutEleByHandle(xc.XC_LoadLayoutZipResEx(id, fileName, password, prefixName, hParent, hParentWnd, hAttachWnd, hModule...))
}
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 不填默认为0.
func NewLayoutEleByStringW(xmlStr string, hParent int, hAttachWnd ...uintptr) *LayoutEle {
	return NewLayoutEleByHandle(xc.XC_LoadLayoutFromStringW(xmlStr, hParent, hAttachWnd...))
}
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 不填默认为0.
func NewLayoutEleByLayoutEx(fileName, prefixName string, hParent int, hParentWnd uintptr, hAttachWnd ...uintptr) *LayoutEle {
	return NewLayoutEleByHandle(xc.XC_LoadLayoutEx(fileName, prefixName, hParent, hParentWnd, hAttachWnd...))
}
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 不填默认为0.
func NewLayoutEleByLayoutZipEx(zipFileName string, fileName string, password, prefixName string, hParent int, hParentWnd uintptr, hAttachWnd ...uintptr) *LayoutEle {
	return NewLayoutEleByHandle(xc.XC_LoadLayoutZipEx(zipFileName, fileName, password, prefixName, hParent, hParentWnd, hAttachWnd...))
}
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 不填默认为0.
func NewLayoutEleByLayoutZipMemEx(data []byte, fileName string, password, prefixName string, hParent int, hParentWnd uintptr, hAttachWnd ...uintptr) *LayoutEle {
	return NewLayoutEleByHandle(xc.XC_LoadLayoutZipMemEx(data, fileName, password, prefixName, hParent, hParentWnd, hAttachWnd...))
}
...
//
// hAttachWnd: 附加窗口句柄, 附加到指定的窗口, 不填默认为0.
func NewLayoutEleByStringWEx(xmlStr, prefixName string, hParent int, hParentWnd uintptr, hAttachWnd ...uintptr) *LayoutEle {
	return NewLayoutEleByHandle(xc.XC_LoadLayoutFromStringWEx(xmlStr, prefixName, hParent, hParentWnd, hAttachWnd...))
}
