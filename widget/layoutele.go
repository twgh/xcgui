...
//	@param hAttachWnd 附加窗口句柄, 附加到指定的窗口, 可填0.
//	@return *LayoutEle
func NewLayoutEleByLayoutEx(pFileName, pPrefixName string, hParent int, hAttachWnd int) *LayoutEle {
...
//	@param hAttachWnd 附加窗口句柄, 附加到指定的窗口, 可填0.
//	@return *LayoutEle
func NewLayoutEleByLayoutZipEx(pZipFileName string, pFileName string, pPassword, pPrefixName string, hParent int, hAttachWnd int) *LayoutEle {
...
//	@param hAttachWnd 附加窗口句柄, 附加到指定的窗口, 可填0.
//	@return *LayoutEle
func NewLayoutEleByLayoutZipMemEx(data []byte, pFileName string, pPassword, pPrefixName string, hParent int, hAttachWnd int) *LayoutEle {
...
//	@param hAttachWnd 附加窗口句柄, 附加到指定的窗口, 可填0.
//	@return *LayoutEle
func NewLayoutEleByStringWEx(pStringXML, pPrefixName string, hParent int, hAttachWnd int) *LayoutEle {
