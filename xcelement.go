...
// 元素_取类型
// hEle: 元素句柄.
func XEle_GetType(hEle int) int {
	r, _, _ := xEle_GetType.Call(uintptr(hEle))
	return int(r)
}

// 元素_取HWND
// hEle: 元素句柄.
func XEle_GetHWND(hEle int) int {
	r, _, _ := xEle_GetHWND.Call(uintptr(hEle))
	return int(r)
}

// 元素_取HWINDOW
// hEle: 元素句柄.
func XEle_GetHWINDOW(hEle int) int {
	r, _, _ := xEle_GetHWINDOW.Call(uintptr(hEle))
	return int(r)
}
...
// hEle: 元素句柄.
// bShow: TRUE显示元素
func XEle_Show(hEle int, bShow bool) int {
	r, _, _ := xEle_Show.Call(uintptr(hEle), boolPtr(bShow))
	return int(r)
}
...
// nFlags: 调整布局标识位, XC_AdjustLayout_
// nAdjustNo:
func XEle_Move(hEle int, x int, y int, bRedraw bool, nFlags int, nAdjustNo int) int {
	r, _, _ := xEle_Move.Call(uintptr(hEle), uintptr(x), uintptr(y), boolPtr(bRedraw), uintptr(nFlags), uintptr(nAdjustNo))
	return int(r)
}
...
// nFlags: 调整布局标识位, XC_AdjustLayout_
// nAdjustNo:
func XEle_MoveLogic(hEle int, x int, y int, bRedraw bool, nFlags int, nAdjustNo int) int {
	r, _, _ := xEle_MoveLogic.Call(uintptr(hEle), uintptr(x), uintptr(y), boolPtr(bRedraw), uintptr(nFlags), uintptr(nAdjustNo))
	return int(r)
}
...
// hEle: 元素句柄.
// nID: ID值.
func XEle_SetID(hEle int, nID int) int {
	r, _, _ := xEle_SetID.Call(uintptr(hEle), uintptr(nID))
	return int(r)
}

// 元素_取ID
// hEle: 元素句柄.
func XEle_GetID(hEle int) int {
	r, _, _ := xEle_GetID.Call(uintptr(hEle))
	return int(r)
}
...
// hEle: 元素句柄.
// nUID: UID值.
func XEle_SetUID(hEle int, nUID int) int {
	r, _, _ := xEle_SetUID.Call(uintptr(hEle), uintptr(nUID))
	return int(r)
}

// 元素_取UID
// hEle: 元素句柄.
func XEle_GetUID(hEle int) int {
	r, _, _ := xEle_GetUID.Call(uintptr(hEle))
	return int(r)
}
...
// hEle: 元素句柄.
// pName: name值
func XEle_SetName(hEle int, pName string) int {
	r, _, _ := xEle_SetName.Call(uintptr(hEle), strPtr(pName))
	return int(r)
}

// 元素_取名称
// hEle: 元素句柄.
func XEle_GetName(hEle int) int {
	r, _, _ := xEle_GetName.Call(uintptr(hEle))
	return int(r)
}

// 元素_判断显示
// hEle: 元素句柄.
func XEle_IsShow(hEle int) bool {
	r, _, _ := xEle_IsShow.Call(uintptr(hEle))
	return int(r) != 0
}
...
// 元素_取父元素
// hEle: 元素句柄.
func XEle_GetParentEle(hEle int) int {
	r, _, _ := xEle_GetParentEle.Call(uintptr(hEle))
	return int(r)
}

// 元素_取父对象, 获取父对象, 父可能是元素或窗口, 通过此函数可以检查是否有父
// hEle: 元素句柄.
func XEle_GetParent(hEle int) int {
	r, _, _ := xEle_GetParent.Call(uintptr(hEle))
	return int(r)
}
...
// color: RGB颜色值.
// alpha: 透明度.
func XEle_SetTextColor(hEle int, color int, alpha uint8) int {
	r, _, _ := xEle_SetTextColor.Call(uintptr(hEle), uintptr(color), uintptr(alpha))
	return int(r)
}
...
// color: RGB颜色值.
// alpha: 透明度.
func XEle_SetFocusBorderColor(hEle int, color int, alpha uint8) int {
	r, _, _ := xEle_SetFocusBorderColor.Call(uintptr(hEle), uintptr(color), uintptr(alpha))
	return int(r)
}
...
// alpha: 透明度.
// width: 线宽.
func XEle_AddBkBorder(hEle int, color int, alpha uint8, width int) int {
	r, _, _ := xEle_AddBkBorder.Call(uintptr(hEle), uintptr(color), uintptr(alpha), uintptr(width))
	return int(r)
}
...
// color: RGB颜色.
// alpha: 透明度.
func XEle_AddBkFill(hEle int, color int, alpha uint8) int {
	r, _, _ := xEle_AddBkFill.Call(uintptr(hEle), uintptr(color), uintptr(alpha))
	return int(r)
}
...
// hEle: 元素句柄.
// hImage: 图片句柄.
func XEle_AddBkImage(hEle int, hImage int) int {
	r, _, _ := xEle_AddBkImage.Call(uintptr(hEle), uintptr(hImage))
	return int(r)
}
...
// cx: 宽度
// cy: 高度
func XEle_GetContentSize(hEle int, bHorizon bool, pSize *SIZE, cx int, cy int) int {
	r, _, _ := xEle_GetContentSize.Call(uintptr(hEle), boolPtr(bHorizon), uintptr(unsafe.Pointer(pSize)), uintptr(cx), uintptr(cy))
	return int(r)
}
