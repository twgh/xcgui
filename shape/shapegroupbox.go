...
func (s *ShapeGroupBox) SetBorderColor(color int, alpha uint8) int {
	return xc.XShapeGroupBox_SetBorderColor(s.HXCGUI, color, alpha)
}
...
func (s *ShapeGroupBox) SetTextColor(color int, alpha uint8) int {
	return xc.XShapeGroupBox_SetTextColor(s.HXCGUI, color, alpha)
}

// 形状组框_置字体
// hFontX: 炫彩字体.
func (s *ShapeGroupBox) SetFontX(hFontX int) int {
	return xc.XShapeGroupBox_SetFontX(s.HXCGUI, hFontX)
}
...
func (s *ShapeGroupBox) SetTextOffset(offsetX int, offsetY int) int {
	return xc.XShapeGroupBox_SetTextOffset(s.HXCGUI, offsetX, offsetY)
}
...
func (s *ShapeGroupBox) SetRoundAngle(nWidth int, nHeight int) int {
	return xc.XShapeGroupBox_SetRoundAngle(s.HXCGUI, nWidth, nHeight)
}

// 形状组框_置文本
// pText: 文本内容.
func (s *ShapeGroupBox) SetText(pText string) int {
	return xc.XShapeGroupBox_SetText(s.HXCGUI, pText)
}
...
func (s *ShapeGroupBox) GetTextOffset(pOffsetX *int, pOffsetY *int) int {
	return xc.XShapeGroupBox_GetTextOffset(s.HXCGUI, pOffsetX, pOffsetY)
}
...
func (s *ShapeGroupBox) GetRoundAngle(pWidth *int, pHeight *int) int {
	return xc.XShapeGroupBox_GetRoundAngle(s.HXCGUI, pWidth, pHeight)
}

// 形状组框_启用圆角
// bEnable: 是否启用.
func (s *ShapeGroupBox) EnableRoundAngle(bEnable bool) int {
	return xc.XShapeGroupBox_EnableRoundAngle(s.HXCGUI, bEnable)
}
