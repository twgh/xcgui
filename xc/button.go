...
func XBtn_SetState(hEle int, nState xcc.Common_State3_) {
	xBtn_SetState.Call(uintptr(hEle), uintptr(nState))
}
...
func XBtn_SetTypeEx(hEle int, nType xcc.XC_OBJECT_TYPE_EX) {
	xBtn_SetTypeEx.Call(uintptr(hEle), uintptr(nType))
}
...
//
// nID: 组ID.
func XBtn_SetGroupID(hEle int, nID int32) {
	xBtn_SetGroupID.Call(uintptr(hEle), uintptr(nID))
}
...
//
// hBindEle: 将要绑定的元素.
func XBtn_SetBindEle(hEle int, hBindEle int) {
	xBtn_SetBindEle.Call(uintptr(hEle), uintptr(hBindEle))
}
...
func XBtn_SetTextAlign(hEle int, nFlags xcc.TextFormatFlag_) {
	xBtn_SetTextAlign.Call(uintptr(hEle), uintptr(nFlags))
}
...
func XBtn_SetIconAlign(hEle int, align xcc.Button_Icon_Align_) {
	xBtn_SetIconAlign.Call(uintptr(hEle), uintptr(align))
}
...
//
// y: 偏移量.
func XBtn_SetOffset(hEle int, x, y int32) {
	xBtn_SetOffset.Call(uintptr(hEle), uintptr(x), uintptr(y))
}
...
//
// y: 偏移量.
func XBtn_SetOffsetIcon(hEle int, x, y int32) {
	xBtn_SetOffsetIcon.Call(uintptr(hEle), uintptr(x), uintptr(y))
}
...
//
// size: 间隔大小.
func XBtn_SetIconSpace(hEle int, size int32) {
	xBtn_SetIconSpace.Call(uintptr(hEle), uintptr(size))
}
...
//
// hImage: 图片句柄.
func XBtn_SetIcon(hEle int, hImage int) {
	xBtn_SetIcon.Call(uintptr(hEle), uintptr(hImage))
}
...
//
// hImage: 图片句柄.
func XBtn_SetIconDisable(hEle int, hImage int) {
	xBtn_SetIconDisable.Call(uintptr(hEle), uintptr(hImage))
}
...
func XBtn_GetIcon(hEle int, nType int32) int {
...
//
// uElapse: 图片帧延时, 单位毫秒.
func XBtn_AddAnimationFrame(hEle int, hImage int, uElapse uint32) {
	xBtn_AddAnimationFrame.Call(uintptr(hEle), uintptr(hImage), uintptr(uElapse))
}
...
//
// bLoopPlay: 是否循环播放.
func XBtn_EnableAnimation(hEle int, bEnable bool, bLoopPlay bool) {
	xBtn_EnableAnimation.Call(uintptr(hEle), common.BoolPtr(bEnable), common.BoolPtr(bLoopPlay))
}
