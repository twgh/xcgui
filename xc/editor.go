...
//
//	hParent: 父为窗口句柄或元素句柄.
func XEditor_Create(x, y, cx, cy int32, hParent int) int {
...
//
//	iRow: 行索引.
func XEditor_IsBreakpoint(hEle int, iRow int32) bool {
...
//
//	bActivate: 是否激活.
func XEditor_SetBreakpoint(hEle int, iRow int32, bActivate bool) bool {
...
//
//	iRow: 行索引.
func XEditor_RemoveBreakpoint(hEle int, iRow int32) bool {
...
//
//	hEle: 元素句柄.
func XEditor_ClearBreakpoint(hEle int) {
	xEditor_ClearBreakpoint.Call(uintptr(hEle))
}
...
//
//	iRow: 行索引.
func XEditor_SetRunRow(hEle int, iRow int32) bool {
...
//
//	pInfo: 颜色信息结构体指针.
func XEditor_GetColor(hEle int, pInfo *Editor_Color_) {
	xEditor_GetColor.Call(uintptr(hEle), uintptr(unsafe.Pointer(pInfo)))
}
...
//
//	pInfo: 颜色信息结构体指针.
func XEditor_SetColor(hEle int, pInfo *Editor_Color_) {
	xEditor_SetColor.Call(uintptr(hEle), uintptr(unsafe.Pointer(pInfo)))
}
...
//
//	hEle: 元素句柄.
func XEditor_GetBreakpointCount(hEle int) int32 {
...
//
//	iRow: 行索引.
func XEditor_SetCurRow(hEle int, iRow int32) {
	xEditor_SetCurRow.Call(uintptr(hEle), uintptr(iRow))
}
...
//
//	iRow: 行索引.
func XEditor_GetDepth(hEle int, iRow int32) int32 {
...
//
//	iRow: 行索引.
func XEditor_ToExpandRow(hEle int, iRow int32) int32 {
...
//
//	iRow: 行索引.
func XEditor_ExpandEx(hEle int, iRow int32) {
	xEditor_ExpandEx.Call(uintptr(hEle), uintptr(iRow))
}
...
//
//	bExpand: 是否展开.
func XEditor_Expand(hEle int, iRow int32, bExpand bool) {
	xEditor_Expand.Call(uintptr(hEle), uintptr(iRow), common.BoolPtr(bExpand))
}
...
//
//	iStyle: 样式.
func XEditor_AddKeyword(hEle int, pKey string, iStyle int32) {
	xEditor_AddKeyword.Call(uintptr(hEle), common.StrPtr(pKey), uintptr(iStyle))
}
...
//
//	pKey: 字符串.
func XEditor_AddConst(hEle int, pKey string) {
	xEditor_AddConst.Call(uintptr(hEle), common.StrPtr(pKey))
}
...
//
//	pKey: 字符串.
func XEditor_AddFunction(hEle int, pKey string) {
	xEditor_AddFunction.Call(uintptr(hEle), common.StrPtr(pKey))
}
...
//
//	pKeyword: 字符串.
func XEditor_AddExcludeDefVarKeyword(hEle int, pKeyword string) {
	xEditor_AddExcludeDefVarKeyword.Call(uintptr(hEle), common.StrPtr(pKeyword))
}
...
//
//	iRow: 行.
func XEditor_GetIndentation(hEle int, iRow int32) int32 {
...
//
//	iRow: 行.
func XEditor_IsEmptyRow(hEle int, iRow int32) bool {
	r, _, _ := xEditor_IsEmptyRow.Call(uintptr(hEle), uintptr(iRow))
	return r != 0
}
...
func XEditor_SetAutoMatchMode(hEle int, mode int32) {
	xEditor_SetAutoMatchMode.Call(uintptr(hEle), uintptr(mode))
}
