...
//
//	duration: 持续时间.
func XNotifyMsg_SetDuration(hWindow int, duration uint32) {
	xNotifyMsg_SetDuration.Call(uintptr(hWindow), uintptr(duration))
}
...
func XNotifyMsg_SetParentMargin(hWindow int, left, top, right, bottom int32) {
	xNotifyMsg_SetParentMargin.Call(uintptr(hWindow), uintptr(left), uintptr(top), uintptr(right), uintptr(bottom))
}
...
//
//	nHeight: 高度.
func XNotifyMsg_SetCaptionHeight(hWindow int, nHeight int32) {
	xNotifyMsg_SetCaptionHeight.Call(uintptr(hWindow), uintptr(nHeight))
}
...
//
//	nWidth: 宽度.
func XNotifyMsg_SetWidth(hWindow int, nWidth int32) {
	xNotifyMsg_SetWidth.Call(uintptr(hWindow), uintptr(nWidth))
}
...
//
//	nSpace: 间隔大小.
func XNotifyMsg_SetSpace(hWindow int, nSpace int32) {
	xNotifyMsg_SetSpace.Call(uintptr(hWindow), uintptr(nSpace))
}
...
//
//	bottom: 底边.
func XNotifyMsg_SetBorderSize(hWindow int, left, top, right, bottom int32) {
	xNotifyMsg_SetBorderSize.Call(uintptr(hWindow), uintptr(left), uintptr(top), uintptr(right), uintptr(bottom))
}
