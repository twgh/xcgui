...
//
//	hParent: 父对象句柄.
func XShapePic_Create(x, y, cx, cy int32, hParent int) int {
...
//
//	hImage: 图片句柄.
func XShapePic_SetImage(hShape int, hImage int) {
	xShapePic_SetImage.Call(uintptr(hShape), uintptr(hImage))
}
