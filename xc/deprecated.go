...
func XList_AddItemImage(hEle int, hImage int) int32 {
...
func XList_InsertItemText(hEle int, iItem int32, pValue string) int32 {
...
func XList_InsertItemImage(hEle int, iItem int32, hImage int) int32 {
...
func XList_DeleteItem(hEle int, iRow int32) bool {
...
func XList_DeleteItemEx(hEle int, iRow, nCount int32) bool {
...
func XList_DeleteItemAll(hEle int) {
	XList_DeleteRowAll(hEle)
}

// Deprecated
//
// !这是旧版函数, 请使用 XList_SetSelectRow
func XList_SetSelectItem(hEle int, iRow int32) bool {
...
func XList_GetSelectItem(hEle int) int32 {
...
func XList_GetSelectItemCount(hEle int) int32 {
...
func XList_AddSelectItem(hEle int, iRow int32) bool {
...
func XList_VisibleItem(hEle int, iRow int32) {
	XList_VisibleRow(hEle, iRow)
}

// Deprecated
//
// !这是旧版函数, 请使用 XList_CancelSelectRow
func XList_CancelSelectItem(hEle int, iRow int32) bool {
...
func XList_GetHeaderItemIndexFromHXCGUI(hEle int, hXCGUI int) int32 {
...
func XList_GetItemIndexFromHXCGUI(hEle int, hXCGUI int) int32 {
...
func XList_SetItemHeightDefault(hEle int, nHeight int32, nSelHeight int32) {
	XList_SetRowHeightDefault(hEle, nHeight, nSelHeight)
}

// Deprecated
//
// !这是旧版函数, 请使用 XList_GetRowHeightDefault
func XList_GetItemHeightDefault(hEle int, pHeight *int32, pSelHeight *int32) {
	XList_GetRowHeightDefault(hEle, pHeight, pSelHeight)
}

// Deprecated
//
// !这是旧版函数, 请使用 XList_SetRowHeight
func XList_SetItemHeight(hEle int, iRow int32, nHeight, nSelHeight int32) {
	XList_SetRowHeight(hEle, iRow, nHeight, nSelHeight)
}

// Deprecated
//
// !这是旧版函数, 请使用 XList_GetRowHeight
func XList_GetItemHeight(hEle int, iRow int32, pHeight, pSelHeight *int32) {
	XList_GetRowHeight(hEle, iRow, pHeight, pSelHeight)
}
...
func XList_RefreshItem(hEle int, iRow int32) {
