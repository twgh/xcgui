...
func XSView_Create(x, y, cx, cy int32, hParent int) int {
...
//
// cy: 高度.
func XSView_SetTotalSize(hEle int, cx, cy int32) bool {
...
//
// pSize: 大小.
func XSView_GetTotalSize(hEle int, pSize *SIZE) {
	xSView_GetTotalSize.Call(uintptr(hEle), uintptr(unsafe.Pointer(pSize)))
}
...
//
// nHeight: 高度.
func XSView_SetLineSize(hEle int, nWidth, nHeight int32) bool {
...
//
// pSize: 返回大小.
func XSView_GetLineSize(hEle int, pSize *SIZE) {
	xSView_GetLineSize.Call(uintptr(hEle), uintptr(unsafe.Pointer(pSize)))
}
...
//
// size: 滚动条大小.
func XSView_SetScrollBarSize(hEle int, size int32) {
	xSView_SetScrollBarSize.Call(uintptr(hEle), uintptr(size))
}

// 滚动视_取视口原点X, 获取视口原点X坐标.
//
// hEle: 元素句柄.
func XSView_GetViewPosH(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XSView_GetViewPosV(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XSView_GetViewWidth(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XSView_GetViewHeight(hEle int) int32 {
...
//
// pRect: 坐标.
func XSView_GetViewRect(hEle int, pRect *RECT) {
	xSView_GetViewRect.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// pos: 位置点.
func XSView_ScrollPosH(hEle int, pos int32) bool {
...
//
// pos: 位置点.
func XSView_ScrollPosV(hEle int, pos int32) bool {
...
//
// posX: X坐标.
func XSView_ScrollPosXH(hEle int, posX int32) bool {
...
//
// posY: Y坐标.
func XSView_ScrollPosYV(hEle int, posY int32) bool {
