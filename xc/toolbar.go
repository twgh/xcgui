...
//
// index: 插入位置索引, (-1)插入末尾.
func XToolBar_InsertEle(hEle int, hNewEle int, index int32) int32 {
...
//
// index: 索引值.
func XToolBar_GetEle(hEle int, index int32) int {
...
//
// nSize: 间距大小.
func XToolBar_SetSpace(hEle int, nSize int32) {
...
//
// index: 索引值.
func XToolBar_DeleteEle(hEle int, index int32) {
...
//
// hEle: 元素句柄.
func XToolBar_DeleteAllEle(hEle int) {
