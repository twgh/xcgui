...
//
// lParam: 参数.
func XEle_SendEvent(hEle int, nEvent xcc.XE_, wParam, lParam uintptr) int32 {
	r, _, _ := xEle_SendEvent.Call(uintptr(hEle), uintptr(nEvent), wParam, lParam)
	return int32(r)
}
...
//
// lParam: 参数.
func XEle_PostEvent(hEle int, nEvent xcc.XE_, wParam, lParam uintptr) bool {
	r, _, _ := xEle_PostEvent.Call(uintptr(hEle), uintptr(nEvent), wParam, lParam)
	return r != 0
}
...
//
// pRect: 坐标.
func XEle_GetRect(hEle int, pRect *RECT) {
	xEle_GetRect.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// pRect: 坐标.
func XEle_GetRectLogic(hEle int, pRect *RECT) {
	xEle_GetRectLogic.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// pRect: 坐标.
func XEle_GetClientRect(hEle int, pRect *RECT) {
	xEle_GetClientRect.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// nWidth: 宽度.
func XEle_SetWidth(hEle int, nWidth int32) {
	xEle_SetWidth.Call(uintptr(hEle), uintptr(nWidth))
}
...
//
// nHeight: 高度.
func XEle_SetHeight(hEle int, nHeight int32) {
	xEle_SetHeight.Call(uintptr(hEle), uintptr(nHeight))
}

// 元素_取宽度.
//
// hEle: 元素句柄.
func XEle_GetWidth(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XEle_GetHeight(hEle int) int32 {
...
//
// pRect: 坐标.
func XEle_RectWndClientToEleClient(hEle int, pRect *RECT) {
	xEle_RectWndClientToEleClient.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// pPt: 坐标.
func XEle_PointWndClientToEleClient(hEle int, pPt *POINT) {
	xEle_PointWndClientToEleClient.Call(uintptr(hEle), uintptr(unsafe.Pointer(pPt)))
}
...
//
// pRect: 坐标.
func XEle_RectClientToWndClient(hEle int, pRect *RECT) {
	xEle_RectClientToWndClient.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// pPt: 坐标.
func XEle_PointClientToWndClient(hEle int, pPt *POINT) {
	xEle_PointClientToWndClient.Call(uintptr(hEle), uintptr(unsafe.Pointer(pPt)))
}
...
//
// pRect: 坐标.
func XEle_GetWndClientRect(hEle int, pRect *RECT) {
	xEle_GetWndClientRect.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}

// 元素_取光标, 获取元素鼠标光标, 返回光标句柄.
//
// hEle: 元素句柄.
func XEle_GetCursor(hEle int) uintptr {
...
//
// index: 插入位置索引.
func XEle_InsertChild(hEle int, hChild int, index int32) bool {
...
//
// hEle: 元素句柄.
func XEle_Remove(hEle int) {
	xEle_Remove.Call(uintptr(hEle))
}
...
//
// index: 位置索引.
func XEle_SetZOrder(hEle int, index int32) bool {
...
//
// hEle: 元素句柄.
func XEle_GetZOrder(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XEle_GetChildCount(hEle int) int32 {
...
//
// index: 索引.
func XEle_GetChildByIndex(hEle int, index int32) int {
...
//
// nID: 元素ID.
func XEle_GetChildByID(hEle int, nID int32) int {
...
//
// bottom: 下边大小.
func XEle_SetBorderSize(hEle int, left, top, right, bottom int32) {
	xEle_SetBorderSize.Call(uintptr(hEle), uintptr(left), uintptr(top), uintptr(right), uintptr(bottom))
}
...
//
// pBorder: 大小.
func XEle_GetBorderSize(hEle int, pBorder *RECT) {
	xEle_GetBorderSize.Call(uintptr(hEle), uintptr(unsafe.Pointer(pBorder)))
}
...
//
// bottom: 下边大小.
func XEle_SetPadding(hEle int, left, top, right, bottom int32) {
	xEle_SetPadding.Call(uintptr(hEle), uintptr(left), uintptr(top), uintptr(right), uintptr(bottom))
}
...
//
// pPadding: 大小.
func XEle_GetPadding(hEle int, pPadding *RECT) {
	xEle_GetPadding.Call(uintptr(hEle), uintptr(unsafe.Pointer(pPadding)))
}
...
func XEle_SetDragBorder(hEle int, nFlags xcc.Element_Position_) {
	xEle_SetDragBorder.Call(uintptr(hEle), uintptr(nFlags))
}
...
//
// nSpace: 元素间隔大小.
func XEle_SetDragBorderBindEle(hEle int, nFlags xcc.Element_Position_, hBindEle int, nSpace int32) {
	xEle_SetDragBorderBindEle.Call(uintptr(hEle), uintptr(nFlags), uintptr(hBindEle), uintptr(nSpace))
}
...
//
// nHeight: 最小高度.
func XEle_SetMinSize(hEle int, nWidth, nHeight int32) {
	xEle_SetMinSize.Call(uintptr(hEle), uintptr(nWidth), uintptr(nHeight))
}
...
//
// nHeight: 最大高度.
func XEle_SetMaxSize(hEle int, nWidth, nHeight int32) {
	xEle_SetMaxSize.Call(uintptr(hEle), uintptr(nWidth), uintptr(nHeight))
}
...
//
// bVertical: 是否锁定垂直滚动.
func XEle_SetLockScroll(hEle int, bHorizon bool, bVertical bool) {
	xEle_SetLockScroll.Call(uintptr(hEle), common.BoolPtr(bHorizon), common.BoolPtr(bVertical))
}
...
//
// hFontx: 炫彩字体.
func XEle_SetFont(hEle int, hFontx int) {
	xEle_SetFont.Call(uintptr(hEle), uintptr(hFontx))
}
...
//
// hEle: 元素句柄.
func XEle_SetAlpha(hEle int, alpha byte) {
	xEle_SetAlpha.Call(uintptr(hEle), uintptr(alpha))
}

// 元素_销毁.
//
// hEle: 元素句柄.
func XEle_Destroy(hEle int) {
...
//
// hImage: 图片句柄.
func XEle_AddBkImage(hEle int, nState xcc.CombinedState, hImage int) {
	xEle_AddBkImage.Call(uintptr(hEle), uintptr(nState), uintptr(hImage))
}

// 元素_取背景对象数量, 获取背景内容数量.
//
// hEle: 元素句柄.
func XEle_GetBkInfoCount(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XEle_ClearBkInfo(hEle int) {
...
//
// hBkInfoM: 背景管理器.
func XEle_SetBkManager(hEle int, hBkInfoM int) {
	xEle_SetBkManager.Call(uintptr(hEle), uintptr(hBkInfoM))
}
...
//
// hDraw: 图形绘制句柄.
func XEle_DrawEle(hEle int, hDraw int) {
	xEle_DrawEle.Call(uintptr(hEle), uintptr(hDraw))
}
...
//
// nData: 用户数据.
func XEle_SetUserData(hEle int, nData int) {
	xEle_SetUserData.Call(uintptr(hEle), uintptr(nData))
}
...
//
// pSize: 返回大小.
func XEle_GetContentSize(hEle int, bHorizon bool, cx, cy int32, pSize *SIZE) {
	xEle_GetContentSize.Call(uintptr(hEle), common.BoolPtr(bHorizon), uintptr(cx), uintptr(cy), uintptr(unsafe.Pointer(pSize)))
}
...
//
// b: TRUE设置.
func XEle_SetCapture(hEle int, b bool) {
	xEle_SetCapture.Call(uintptr(hEle), common.BoolPtr(b))
}
...
//
// uElapse: 延时毫秒.
func XEle_SetXCTimer(hEle int, nIDEvent, uElapse uint32) bool {
...
//
// nIDEvent: 事件ID.
func XEle_KillXCTimer(hEle int, nIDEvent uint32) bool {
...
//
// hEle: 元素句柄.
func XEle_GetToolTip(hEle int) string {
...
//
// y: Y坐标.
func XEle_PopupToolTip(hEle int, x, y int32) {
	xEle_PopupToolTip.Call(uintptr(hEle), uintptr(x), uintptr(y))
}
...
//
// pOutY: 返回Y坐标.
func XEle_GetPosition(hEle int, pOutX, pOutY *int32) {
	xEle_GetPosition.Call(uintptr(hEle), uintptr(unsafe.Pointer(pOutX)), uintptr(unsafe.Pointer(pOutY)))
}
...
//
// pOutHeight: 返回高度.
func XEle_GetSize(hEle int, pOutWidth, pOutHeight *int32) {
	xEle_GetSize.Call(uintptr(hEle), uintptr(unsafe.Pointer(pOutWidth)), uintptr(unsafe.Pointer(pOutHeight)))
}
...
//
// pRect: 接收返回坐标.
func XEle_GetWndClientRectDPI(hEle int, pRect *RECT) {
	xEle_GetWndClientRectDPI.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// pPt: 接收返回坐标点.
func XEle_PointClientToWndClientDPI(hEle int, pPt *POINT) {
	xEle_PointClientToWndClientDPI.Call(uintptr(hEle), uintptr(unsafe.Pointer(pPt)))
}
...
//
// pRect: 接收返回坐标.
func XEle_RectClientToWndClientDPI(hEle int, pRect *RECT) {
	xEle_RectClientToWndClientDPI.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// bEnable: 是否启用.
func XPGrid_EnableExpandCurGroupOnly(hEle int, bEnable bool) {
	xPGrid_EnableExpandCurGroupOnly.Call(uintptr(hEle), common.BoolPtr(bEnable))
}
