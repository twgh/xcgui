...
func XComboBox_Create(x, y, cx, cy int32, hParent int) int {
...
//
// iIndex: 项索引.
func XComboBox_SetSelItem(hEle int, iIndex int32) bool {
...
//
// hAdapter: 适配器句柄.
func XComboBox_BindAdapter(hEle int, hAdapter int) {
	xComboBox_BindAdapter.Call(uintptr(hEle), uintptr(hAdapter))
}
...
//
// pRect: 坐标.
func XComboBox_GetButtonRect(hEle int, pRect *RECT) {
	xComboBox_GetButtonRect.Call(uintptr(hEle), uintptr(unsafe.Pointer(pRect)))
}
...
//
// size: 大小.
func XComboBox_SetButtonSize(hEle int, size int32) {
	xComboBox_SetButtonSize.Call(uintptr(hEle), uintptr(size))
}
...
//
// height: 高度, -1自动计算高度.
func XComboBox_SetDropHeight(hEle int, height int32) {
	xComboBox_SetDropHeight.Call(uintptr(hEle), uintptr(height))
}

// 组合框_取下拉列表高度.
//
// hEle: 元素句柄.
func XComboBox_GetDropHeight(hEle int) int32 {
...
//
// pXmlFile: 项模板文件.
func XComboBox_SetItemTemplateXML(hEle int, pXmlFile string) {
	xComboBox_SetItemTemplateXML.Call(uintptr(hEle), common.StrPtr(pXmlFile))
}
...
//
// hEle: 元素句柄.
func XComboBox_GetSelItem(hEle int) int32 {
...
//
// hImage: 图片句柄.
func XComboBox_AddItemImage(hEle int, hImage int) int32 {
...
//
// hImage: 图片句柄.
func XComboBox_InsertItemImage(hEle int, iItem int32, hImage int) int32 {
...
//
// hImage: 图片句柄.
func XComboBox_SetItemImage(hEle int, iItem, iColumn int32, hImage int) bool {
...
//
// nValue: 整数值.
func XComboBox_SetItemInt(hEle int, iItem, iColumn, nValue int32) bool {
...
//
// fFloat: 浮点数.
func XComboBox_SetItemFloat(hEle int, iItem, iColumn int32, fFloat float32) bool {
...
//
// iColumn: 列索引.
func XComboBox_GetItemText(hEle int, iItem, iColumn int32) string {
...
//
// iColumn: 列索引.
func XComboBox_GetItemImage(hEle int, iItem, iColumn int32) int {
...
//
// pOutValue: 接收返回整数值.
func XComboBox_GetItemInt(hEle int, iItem, iColumn int32, pOutValue *int32) bool {
...
//
// pOutValue: 接收返回浮点值.
func XComboBox_GetItemFloat(hEle int, iItem, iColumn int32, pOutValue *float32) bool {
...
//
// iItem: 项索引.
func XComboBox_DeleteItem(hEle int, iItem int32) bool {
...
//
// nCount: 删除数量.
func XComboBox_DeleteItemEx(hEle int, iItem, nCount int32) bool {
...
//
// hEle: 元素句柄.
func XComboBox_DeleteItemAll(hEle int) {
	xComboBox_DeleteItemAll.Call(uintptr(hEle))
}

// 组合框_删除列全部.
//
// hEle: 元素句柄.
func XComboBox_DeleteColumnAll(hEle int) {
	xComboBox_DeleteColumnAll.Call(uintptr(hEle))
}

// 组合框_取项数量.
//
// hEle:.
func XComboBox_GetCount(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XComboBox_GetCountColumn(hEle int) int32 {
...
//
// hEle: 元素句柄.
func XComboBox_PopupDropList(hEle int) {
	xComboBox_PopupDropList.Call(uintptr(hEle))
}
...
//
// hModule: 模块句柄, 不填默认为0.
func XComboBox_SetItemTemplateXMLFromZipRes(hEle int, id int32, fileName string, password string, hModule ...uintptr) bool {
	module := uintptr(0)
	if len(hModule) > 0 {
		module = hModule[0]
	}
	r, _, _ := xComboBox_SetItemTemplateXMLFromZipRes.Call(uintptr(hEle), uintptr(id), common.StrPtr(fileName), common.StrPtr(password), module)
	return r != 0
}
