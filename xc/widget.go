...
//
// nWidth: 宽度.
func XWidget_LayoutItem_SetWidth(hXCGUI int, nType xcc.Layout_Size_, nWidth int32) {
	xWidget_LayoutItem_SetWidth.Call(uintptr(hXCGUI), uintptr(nType), uintptr(nWidth))
}
...
//
// nHeight: 高度.
func XWidget_LayoutItem_SetHeight(hXCGUI int, nType xcc.Layout_Size_, nHeight int32) {
	xWidget_LayoutItem_SetHeight.Call(uintptr(hXCGUI), uintptr(nType), uintptr(nHeight))
}
...
//
// pWidth: 返回宽度.
func XWidget_LayoutItem_GetWidth(hXCGUI int, pType *xcc.Layout_Size_, pWidth *int32) {
	xWidget_LayoutItem_GetWidth.Call(uintptr(hXCGUI), uintptr(unsafe.Pointer(pType)), uintptr(unsafe.Pointer(pWidth)))
}
...
//
// pHeight: 返回高度.
func XWidget_LayoutItem_GetHeight(hXCGUI int, pType *xcc.Layout_Size_, pHeight *int32) {
	xWidget_LayoutItem_GetHeight.Call(uintptr(hXCGUI), uintptr(unsafe.Pointer(pType)), uintptr(unsafe.Pointer(pHeight)))
}
...
func XWidget_LayoutItem_SetAlign(hXCGUI int, nAlign xcc.Layout_Align_Axis_) {
	xWidget_LayoutItem_SetAlign.Call(uintptr(hXCGUI), uintptr(nAlign))
}

// 窗口组件_布局项_置外间距.
//
// hXCGUI: UI对象句柄.
func XWidget_LayoutItem_SetMargin(hXCGUI int, left, top, right, bottom int32) {
	xWidget_LayoutItem_SetMargin.Call(uintptr(hXCGUI), uintptr(left), uintptr(top), uintptr(right), uintptr(bottom))
}
...
//
// pMargin: 接收返回.
func XWidget_LayoutItem_GetMargin(hXCGUI int, pMargin *RECT) {
	xWidget_LayoutItem_GetMargin.Call(uintptr(hXCGUI), uintptr(unsafe.Pointer(pMargin)))
}
...
//
// height: 最小高度.
func XWidget_LayoutItem_SetMinSize(hXCGUI int, width, height int32) {
	xWidget_LayoutItem_SetMinSize.Call(uintptr(hXCGUI), uintptr(width), uintptr(height))
}
...
//
// bottom: 下边距离.
func XWidget_LayoutItem_SetPosition(hXCGUI int, left, top, right, bottom int32) {
	xWidget_LayoutItem_SetPosition.Call(uintptr(hXCGUI), uintptr(left), uintptr(top), uintptr(right), uintptr(bottom))
}
...
//
// nID: ID值.
func XWidget_SetID(hXCGUI int, nID int32) {
	xWidget_SetID.Call(uintptr(hXCGUI), uintptr(nID))
}
...
//
// nUID: UID值.
func XWidget_SetUID(hXCGUI int, nUID int32) {
	xWidget_SetUID.Call(uintptr(hXCGUI), uintptr(nUID))
}
