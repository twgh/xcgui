...
//
// hParent: 父对象句柄.
func XShapeRect_Create(x, y, cx, cy int32, hParent int) int {
...
//
// color: xc.RGBA 颜色值.
func XShapeRect_SetBorderColor(hShape int, color uint32) {
...
//
// color: xc.RGBA 颜色值.
func XShapeRect_SetFillColor(hShape int, color uint32) {
...
//
// nHeight: 圆角高度.
func XShapeRect_SetRoundAngle(hShape int, nWidth int, nHeight int32) {
	xShapeRect_SetRoundAngle.Call(uintptr(hShape), uintptr(nWidth), uintptr(nHeight))
}
...
//
// pHeight: 圆角高度.
func XShapeRect_GetRoundAngle(hShape int, pWidth *int, pHeight *int32) {
	xShapeRect_GetRoundAngle.Call(uintptr(hShape), uintptr(unsafe.Pointer(pWidth)), uintptr(unsafe.Pointer(pHeight)))
}
