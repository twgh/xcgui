...
func XTabBar_Create(x, y, cx, cy int32, hParent int) int {
...
//
//	iDest: 目标位置索引.
func XTabBar_MoveLabel(hEle int, iSrc, iDest int32) bool {
...
//
//	index: 位置索引.
func XTabBar_DeleteLabel(hEle int, index int32) bool {
...
//
//	hEle: 元素句柄.
func XTabBar_DeleteLabelAll(hEle int) {
...
//
//	index: 位置索引.
func XTabBar_GetLabel(hEle int, index int32) int {
...
//
//	index: 位置索引.
func XTabBar_GetLabelClose(hEle int, index int32) int {
...
//
//	hEle: 元素句柄.
func XTabBar_GetSelect(hEle int) int32 {
...
//
//	hEle: 元素句柄.
func XTabBar_GetLabelSpacing(hEle int) int32 {
...
//
//	hEle: 元素句柄.
func XTabBar_GetLabelCount(hEle int) int32 {
...
//
//	hLabel: 标签按钮句柄.
func XTabBar_GetindexByEle(hEle int, hLabel int) int32 {
...
//
//	spacing: 标签间隔大小.
func XTabBar_SetLabelSpacing(hEle int, spacing int32) {
	xTabBar_SetLabelSpacing.Call(uintptr(hEle), uintptr(spacing))
}
...
//
//	bottom: 下边间隔大小.
func XTabBar_SetPadding(hEle int, left, top, right, bottom int32) {
	xTabBar_SetPadding.Call(uintptr(hEle), uintptr(left), uintptr(top), uintptr(right), uintptr(bottom))
}
...
//
//	index: 标签位置索引.
func XTabBar_SetSelect(hEle int, index int32) {
	xTabBar_SetSelect.Call(uintptr(hEle), uintptr(index))
}

// TAB条_左滚动, 左按钮滚动.
//
//	hEle: 元素句柄.
func XTabBar_SetUp(hEle int) {
...
func XTabBar_SetCloseSize(hEle int, pSize *SIZE) {
	xTabBar_SetCloseSize.Call(uintptr(hEle), uintptr(unsafe.Pointer(pSize)))
}
...
//
//	pSize: 大小值, 宽度和高度可以为-1, -1代表默认值.
func XTabBar_SetTurnButtonSize(hEle int, pSize *SIZE) {
	xTabBar_SetTurnButtonSize.Call(uintptr(hEle), uintptr(unsafe.Pointer(pSize)))
}
...
func XTabBar_SetLabelWidth(hEle int, index, nWidth int32) {
	xTabBar_SetLabelWidth.Call(uintptr(hEle), uintptr(index), uintptr(nWidth))
}
...
//
//	bShow: 是否显示.
func XTabBar_ShowLabel(hEle int, index int32, bShow bool) bool {
