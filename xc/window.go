...
//
// fn: 事件函数.
func XWnd_RegEventC(hWindow int, nEvent xcc.WM_, fn interface{}) bool {
	r, _, _ := xWnd_RegEventC.Call(uintptr(hWindow), uintptr(nEvent), syscall.NewCallback(fn))
	return r != 0
}
...
//
// fn: 事件函数.
func XWnd_RegEventC1(hWindow int, nEvent xcc.WM_, fn interface{}) bool {
	r, _, _ := xWnd_RegEventC1.Call(uintptr(hWindow), uintptr(nEvent), syscall.NewCallback(fn))
	return r != 0
}
...
//
// fn: 事件函数.
func XWnd_RemoveEventC(hWindow int, nEvent xcc.WM_, fn interface{}) bool {
	r, _, _ := xWnd_RemoveEventC.Call(uintptr(hWindow), uintptr(nEvent), syscall.NewCallback(fn))
	return r != 0
}
