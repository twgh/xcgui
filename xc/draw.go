...
func XDraw_Dottedline(hDraw int, x1, y1, x2, y2 int32) {
	xDraw_Dottedline.Call(uintptr(hDraw), uintptr(x1), uintptr(y1), uintptr(x2), uintptr(y2))
}
...
func XDraw_DottedlineF(hDraw int, x1, y1, x2, y2 float32) {
	xDraw_DottedlineF.Call(uintptr(hDraw), common.Float32Ptr(x1), common.Float32Ptr(y1), common.Float32Ptr(x2), common.Float32Ptr(y2))
}
...
func XDraw_DrawArc(hDraw int, x, y, nWidth, nHeight int32, startAngle, sweepAngle float32) {
	xDraw_DrawArc.Call(uintptr(hDraw), uintptr(x), uintptr(y), uintptr(nWidth), uintptr(nHeight), common.Float32Ptr(startAngle), common.Float32Ptr(sweepAngle))
}
...
func XDraw_DrawArcF(hDraw int, x, y, nWidth, nHeight, startAngle, sweepAngle float32) {
	xDraw_DrawArcF.Call(uintptr(hDraw), common.Float32Ptr(x), common.Float32Ptr(y), common.Float32Ptr(nWidth), common.Float32Ptr(nHeight), common.Float32Ptr(startAngle), common.Float32Ptr(sweepAngle))
}
...
func XDraw_DrawLine(hDraw int, x1, y1, x2, y2 int32) {
	xDraw_DrawLine.Call(uintptr(hDraw), uintptr(x1), uintptr(y1), uintptr(x2), uintptr(y2))
}
...
func XDraw_DrawLineF(hDraw int, x1, y1, x2, y2 float32) {
	xDraw_DrawLineF.Call(uintptr(hDraw), common.Float32Ptr(x1), common.Float32Ptr(y1), common.Float32Ptr(x2), common.Float32Ptr(y2))
}
...
func XDraw_DrawRect(hDraw int, pRect *RECT) {
	xDraw_DrawRect.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
func XDraw_GetOffset(hDraw int, pX, pY *int32) {
	xDraw_GetOffset.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pX)), uintptr(unsafe.Pointer(pY)))
}
...
func XDraw_GDI_RestoreGDIOBJ(hDraw int) {
	xDraw_GDI_RestoreGDIOBJ.Call(uintptr(hDraw))
}
...
func XDraw_SetTextVertical(hDraw int, bVertical bool) {
	xDraw_SetTextVertical.Call(uintptr(hDraw), common.BoolPtr(bVertical))
}
...
func XDraw_SetTextAlign(hDraw int, nFlags xcc.TextFormatFlag_) {
	xDraw_SetTextAlign.Call(uintptr(hDraw), uintptr(nFlags))
}
...
func XDraw_SetFont(hDraw int, hFontx int) {
	xDraw_SetFont.Call(uintptr(hDraw), uintptr(hFontx))
}
...
func XDraw_SetLineWidth(hDraw int, nWidth int32) {
	xDraw_SetLineWidth.Call(uintptr(hDraw), uintptr(nWidth))
}
...
func XDraw_SetLineWidthF(hDraw int, nWidth float32) {
	xDraw_SetLineWidthF.Call(uintptr(hDraw), common.Float32Ptr(nWidth))
}
...
func XDraw_SetClipRect(hDraw int, pRect *RECT) {
	xDraw_SetClipRect.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
func XDraw_SetD2dTextRenderingMode(hDraw int, mode xcc.XC_DWRITE_RENDERING_MODE_) {
	xDraw_SetD2dTextRenderingMode.Call(uintptr(hDraw), uintptr(mode))
}
...
func XDraw_ClearClip(hDraw int) {
	xDraw_ClearClip.Call(uintptr(hDraw))
}
...
//
// nBottomRect: 右下角Y坐标.
func XDraw_GDI_CreateRectRgn(hDraw int, nLeftRect, nTopRect, nRightRect, nBottomRect int32) uintptr {
...
func XDraw_GDI_CreateRoundRectRgn(hDraw int, nLeftRect, nTopRect, nRightRect, nBottomRect, nWidthEllipse, nHeightEllipse int32) uintptr {
...
func XDraw_GDI_SelectClipRgn(hDraw int, hRgn uintptr) int32 {
	r, _, _ := xDraw_GDI_SelectClipRgn.Call(uintptr(hDraw), hRgn)
	return int32(r)
}
...
func XDraw_FillRect(hDraw int, pRect *RECT) {
	xDraw_FillRect.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
func XDraw_FillRectF(hDraw int, pRect *RECTF) {
	xDraw_FillRectF.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
//
// hbr: 画刷句柄.
func XDraw_GDI_FillRgn(hDraw int, hrgn, hbr uintptr) bool {
	r, _, _ := xDraw_GDI_FillRgn.Call(uintptr(hDraw), hrgn, hbr)
	return r != 0
}
...
func XDraw_FillEllipse(hDraw int, pRect *RECT) {
	xDraw_FillEllipse.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
func XDraw_FillEllipseF(hDraw int, pRect *RECTF) {
	xDraw_FillEllipseF.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
func XDraw_DrawEllipse(hDraw int, pRect *RECT) {
	xDraw_DrawEllipse.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
func XDraw_FillRoundRect(hDraw int, pRect *RECT, nWidth, nHeight int32) {
	xDraw_FillRoundRect.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), uintptr(nWidth), uintptr(nHeight))
}
...
func XDraw_FillRoundRectF(hDraw int, pRect *RECTF, nWidth, nHeight float32) {
	xDraw_FillRoundRectF.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), common.Float32Ptr(nWidth), common.Float32Ptr(nHeight))
}
...
func XDraw_DrawRoundRect(hDraw int, pRect *RECT, nWidth, nHeight int32) {
	xDraw_DrawRoundRect.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), uintptr(nWidth), uintptr(nHeight))
}
...
func XDraw_DrawRoundRectF(hDraw int, pRect *RECT, nWidth, nHeight float32) {
	xDraw_DrawRoundRectF.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), common.Float32Ptr(nWidth), common.Float32Ptr(nHeight))
}
...
func XDraw_FillRoundRectEx(hDraw int, pRect *RECT, nLeftTop, nRightTop, nRightBottom, nLeftBottom int32) {
	xDraw_FillRoundRectEx.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), uintptr(nLeftTop), uintptr(nRightTop), uintptr(nRightBottom), uintptr(nLeftBottom))
}
...
func XDraw_FillRoundRectExF(hDraw int, pRect *RECTF, nLeftTop, nRightTop, nRightBottom, nLeftBottom float32) {
	xDraw_FillRoundRectExF.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), common.Float32Ptr(nLeftTop), common.Float32Ptr(nRightTop), common.Float32Ptr(nRightBottom), common.Float32Ptr(nLeftBottom))
}
...
func XDraw_DrawRoundRectEx(hDraw int, pRect *RECT, nLeftTop, nRightTop, nRightBottom, nLeftBottom int32) {
	xDraw_DrawRoundRectEx.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), uintptr(nLeftTop), uintptr(nRightTop), uintptr(nRightBottom), uintptr(nLeftBottom))
}
...
func XDraw_DrawRoundRectExF(hDraw int, pRect *RECT, nLeftTop, nRightTop, nRightBottom, nLeftBottom float32) {
	xDraw_DrawRoundRectExF.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)), common.Float32Ptr(nLeftTop), common.Float32Ptr(nRightTop), common.Float32Ptr(nRightBottom), common.Float32Ptr(nLeftBottom))
}
...
//
// nHeight: 边框高度, 水平边.
func XDraw_GDI_FrameRgn(hDraw int, hrgn, hbr uintptr, nWidth, nHeight int32) bool {
	r, _, _ := xDraw_GDI_FrameRgn.Call(uintptr(hDraw), hrgn, hbr, uintptr(nWidth), uintptr(nHeight))
	return r != 0
}
...
func XDraw_FocusRect(hDraw int, pRect *RECT) {
	xDraw_FocusRect.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
func XDraw_FocusRectF(hDraw int, pRect *RECTF) {
	xDraw_FocusRectF.Call(uintptr(hDraw), uintptr(unsafe.Pointer(pRect)))
}
...
//
// diFlags: .
func XDraw_GDI_DrawIconEx(hDraw int, xLeft, yTop int32, hIcon uintptr, cxWidth, cyWidth int32, istepIfAniCur uint32, hbrFlickerFreeDraw uintptr, diFlags uint32) bool {
	r, _, _ := xDraw_GDI_DrawIconEx.Call(uintptr(hDraw), uintptr(xLeft), uintptr(yTop), hIcon, uintptr(cxWidth), uintptr(cyWidth), uintptr(istepIfAniCur), hbrFlickerFreeDraw, uintptr(diFlags))
	return r != 0
}
...
func XDraw_ImageF(hDraw int, hImageFrame int, x, y float32) {
	xDraw_ImageF.Call(uintptr(hDraw), uintptr(hImageFrame), common.Float32Ptr(x), common.Float32Ptr(y))
}
...
func XDraw_ImageAdaptive(hDraw int, hImageFrame int, pRect *RECT, bOnlyBorder bool) {
	xDraw_ImageAdaptive.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(pRect)), common.BoolPtr(bOnlyBorder))
}
...
func XDraw_ImageAdaptiveF(hDraw int, hImageFrame int, pRect *RECTF, bOnlyBorder bool) {
	xDraw_ImageAdaptiveF.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(pRect)), common.BoolPtr(bOnlyBorder))
}
...
func XDraw_ImageEx(hDraw int, hImageFrame int, x, y, width, height int32) {
	xDraw_ImageEx.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(x), uintptr(y), uintptr(width), uintptr(height))
}
...
func XDraw_ImageExF(hDraw int, hImageFrame int, x, y, width, height float32) {
	xDraw_ImageExF.Call(uintptr(hDraw), uintptr(hImageFrame), common.Float32Ptr(x), common.Float32Ptr(y), common.Float32Ptr(width), common.Float32Ptr(height))
}
...
func XDraw_ImageSuper(hDraw int, hImageFrame int, pRect *RECT, bClip bool) {
	xDraw_ImageSuper.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(pRect)), common.BoolPtr(bClip))
}
...
func XDraw_ImageSuperF(hDraw int, hImageFrame int, pRect *RECTF, bClip bool) {
	xDraw_ImageSuperF.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(pRect)), common.BoolPtr(bClip))
}
...
func XDraw_ImageSuperEx(hDraw int, hImageFrame int, prcDest *RECT, prcSrc *RECT) {
	xDraw_ImageSuperEx.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(prcDest)), uintptr(unsafe.Pointer(prcSrc)))
}
...
func XDraw_ImageSuperExF(hDraw int, hImageFrame int, prcDest *RECTF, prcSrc *RECT) {
	xDraw_ImageSuperExF.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(prcDest)), uintptr(unsafe.Pointer(prcSrc)))
}
...
func XDraw_ImageSuperMask(hDraw int, hImageFrame int, hImageFrameMask int, pRect *RECT, pRectMask *RECT, bClip bool) {
	xDraw_ImageSuperMask.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(hImageFrameMask), uintptr(unsafe.Pointer(pRect)), uintptr(unsafe.Pointer(pRectMask)), common.BoolPtr(bClip))
}
...
func XDraw_ImageTile(hDraw int, hImageFrame int, hImageFrameMask int, pRect *RECT, flag int32) {
	xDraw_ImageTile.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(hImageFrameMask), uintptr(unsafe.Pointer(pRect)), uintptr(flag))
}
...
func XDraw_ImageTileF(hDraw int, hImageFrame int, hImageFrameMask int, pRect *RECTF, flag int32) {
	xDraw_ImageTileF.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(hImageFrameMask), uintptr(unsafe.Pointer(pRect)), uintptr(flag))
}
...
func XDraw_ImageMask(hDraw int, hImageFrame int, hImageFrameMask int, pRect *RECT, x, y int32) {
	xDraw_ImageMask.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(hImageFrameMask), uintptr(unsafe.Pointer(pRect)), uintptr(x), uintptr(y))
}
...
func XDraw_ImageMaskRect(hDraw int, hImageFrame int, pRect *RECT, pRcMask *RECT, pRcRoundAngle *RECT) {
	xDraw_ImageMaskRect.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(pRect)), uintptr(unsafe.Pointer(pRcMask)), uintptr(unsafe.Pointer(pRcRoundAngle)))
}
...
func XDraw_ImageMaskEllipse(hDraw int, hImageFrame int, pRect *RECT, pRcMask *RECT) {
	xDraw_ImageMaskEllipse.Call(uintptr(hDraw), uintptr(hImageFrame), uintptr(unsafe.Pointer(pRect)), uintptr(unsafe.Pointer(pRcMask)))
}
...
func XDraw_SetTextRenderingHint(hDraw int, nType int32) {
	xDraw_SetTextRenderingHint.Call(uintptr(hDraw), uintptr(nType))
}
...
func XDraw_DrawSvgSrc(hDraw int, hSvg int) {
	xDraw_DrawSvgSrc.Call(uintptr(hDraw), uintptr(hSvg))
}
...
func XDraw_DrawSvg(hDraw int, hSvg int, x, y int32) {
	xDraw_DrawSvg.Call(uintptr(hDraw), uintptr(hSvg), uintptr(x), uintptr(y))
}
...
func XDraw_DrawSvgEx(hDraw int, hSvg int, x, y, nWidth, nHeight int32) {
	xDraw_DrawSvgEx.Call(uintptr(hDraw), uintptr(hSvg), uintptr(x), uintptr(y), uintptr(nWidth), uintptr(nHeight))
}
...
func XDraw_DrawSvgSize(hDraw int, hSvg int, nWidth, nHeight int32) {
	xDraw_DrawSvgSize.Call(uintptr(hDraw), uintptr(hSvg), uintptr(nWidth), uintptr(nHeight))
}
